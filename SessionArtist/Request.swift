...
public extension Request {
  @discardableResult func data(_ completion: @escaping DataCompletionHandler) -> URLSessionTask {
    return makeTask(completion: completion)
  }
    
    
  @discardableResult func json(_ completion: @escaping JSONCompletionHandler) -> URLSessionTask {
  ...
  @discardableResult func jsonObject(_ completion: @escaping JSONObjectCompletionHandler) -> URLSessionTask {
    return data(Helper.dataHandler(from: completion) {
  ...
  @discardableResult func jsonArray(_ completion: @escaping JSONArrayCompletionHandler) -> URLSessionTask {
    return data(Helper.dataHandler(from: completion) {
